...
raw_image = Image.open("../data/train/ann_6774630/3ef423610a3f27e29ddebff8420362cb54622701.jpg").convert("RGB")
caption = get_caption(raw_image,model,vis_processors,device)
print(caption)
...
#     print("Starting...")
#     nRows = 100
#     prepareTasksLists(df['images'], nRows, 37, model, vis_processors,device)
#     end = time.time()
